...
<head>
    ...
    <title>KR Legends - Créditos</title>
...
<body class="bg-black text-white">
    ...
    <section id="hero" class="min-vh-100 d-flex align-items-center text-center position-relative overflow-hidden">
        ...
        <div class="container position-relative hero-content">
            <h1 class="display-2 fw-bold text-warning mb-4 fade-in" data-translate="hero.pitstop">Créditos do KR Legends
            </h1>
            <p class="lead text-white mb-5 mx-auto slide-up" style="max-width: 600px;" data-translate="hero.subtitle">
                Aqui homenageamos todos os apoios que transformaram uma ideia numa realidade. Desde o primeiro
                brainstorm até ao lançamento, cada passo foi apoiado por pessoas e instituições extraordinárias.
            </p>
