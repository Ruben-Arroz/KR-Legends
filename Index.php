...
<script>
/* KR PWA helper — deve ficar no <head> para capturar beforeinstallprompt cedo */
(function(){
  if (window._kr_pwa_helper) return;
  window._kr_pwa_helper = true;
  window.deferredPWAInstall = null;

  window.addEventListener('beforeinstallprompt', function(e){
    e.preventDefault();
    window.deferredPWAInstall = e;
    console.log('KR PWA: beforeinstallprompt capturado');
    document.dispatchEvent(new CustomEvent('pwa:ready'));
  });

  window.addEventListener('appinstalled', function(evt){
    console.log('KR PWA: appinstalled', evt);
    window.deferredPWAInstall = null;
    ...
    <link href="css/pwa_section.css" rel="stylesheet">
...
<body class="bg-black text-white">
    ...
    <section id="hero" class="min-vh-100 d-flex align-items-center text-center position-relative overflow-hidden">
        ...
        <div class="container position-relative hero-content">
            <h1 class="display-2 fw-bold text-warning mb-4 fade-in" data-translate="hero.welcome">Bem-vindo ao KR
                Legends</h1>
            <p class="lead text-white mb-5 mx-auto slide-up" style="max-width: 600px;" data-translate="hero.subtitle">
                Explora o universo de corridas de rua com o KR Legends. Um jogo criado no Roblox Studio que combina
                adrenalina, estratégia e drift para criar uma experiência única!
            </p>
    ...
    <section id="dynamicContent" class="py-5 bg-black">
        <!-- Content will be loaded dynamically via JavaScript -->
    </section>

    <?php $PWA_SECTION_LOCALE = 'pt'; include __DIR__ . '/includes/pwa_section.php'; ?>
    ...
    <script src="js/Traducoes/translations_paginainicial.js"></script>
    <script src="js/Gerais/notification_API.js" defer></script>

    <script src="js/pwa_install.js" data-api-base="/~a29621/KRLegends/api"></script>
    <script src="js/pwa_contador.js" data-api-base="/~a29621/KRLegends/api"></script>
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', async () => {
    try {
      ...
      console.log('SW registado com scope:', reg.scope);
    } catch (err) {
