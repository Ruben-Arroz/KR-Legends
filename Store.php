...
<head>
    ...
    <!-- ========== TÍTULO DA PÁGINA ========== -->
    <title>KR Legends - Online Store</title>
...
<body class="bg-black text-white">
    ...
    <header class="fixed-top bg-black bg-opacity-90 border-bottom border-warning border-opacity-25">
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container">
                ...
                <!-- Botão de menu responsivo personalizado -->
                <button class="menu-toggle" id="menuToggle">
                    <!-- Ícone de menu (hambúrguer) -->
                    <svg class="menu-icon" width="1" height="1" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        stroke-width="2">
                        <path d="M3 12h18M3 6h18M3 18h18" />
                    </svg>
                    <!-- Ícone de fechar (X) -->
                    <svg class="close-icon hidden" width="1" height="1" viewBox="0 0 24 24" fill="none"
    ...
    <main class="main">
        <div class="container">
            ...
            <div class="shop-controls">
                ...
                <div class="search-bar">
                    <button id="filterToggle" class="filter-toggle">
                        ...
                        <i class="bi bi-funnel-fill" style="display:none;"></i>
                    </button>

                    <input type="text" id="searchInput" placeholder="Pesquisar produtos..." class="search-input">
                ...
                <!-- Filtros de cor, género, preço e ordem -->
                <div class="filters">
            ...
            <!-- Grelha de produtos (conteúdo será gerado por JavaScript) -->
