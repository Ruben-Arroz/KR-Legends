...
<head>
  ...
  <title>KR Legends - Modos de Jogo</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
  <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css" rel="stylesheet">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
  <link href="css/modos-de-jogo.css" rel="stylesheet">
...
<body class="bg-black text-white">
  ...
  <section id="hero" class="min-vh-100 d-flex align-items-center text-center position-relative overflow-hidden">
    ...
    <div class="container position-relative hero-content">
      <h1 class="display-2 fw-bold text-warning mb-4 fade-in" data-translate="hero.pitstop">Modos de Jogo</h1>
      <p class="lead text-white mb-5 mx-auto slide-up" style="max-width: 600px;" data-translate="hero.subtitle">
        Conheça os diversos modos de jogo e eleve a sua experiência de corrida a um novo patamar.
      </p>
  ...
  <!-- Available Game Modes Section -->
  <section class="game-modes-section">
    <div class="container">
      <h2 class="section-title  text-warning mb-5">Modos de Jogo Disponíveis</h2>
      <p class="lead mb-5">Experimente já estes modos que te farão sentir a adrenalina de um piloto profissional. Cada
        modo foi cuidadosamente desenhado para proporcionar experiências únicas de condução.</p>

      <!-- Game modes will be dynamically loaded here -->
      <div id="available-modes-container">
  ...
  <!-- Future Game Modes Section -->
  <section class="future-modes-section">
    <div class="container">
      <h2 class="section-title text-warning mb-5">Futuros Modos de Jogo</h2>
      <p class="lead mb-5">Fique atento ao que vem por aí. A nossa equipa está a trabalhar arduamente para trazer
        experiências inovadoras que revolucionarão a forma como jogas KR Legends.</p>

      <!-- Future game modes will be dynamically loaded here -->
      <div id="future-modes-container">
        <div class="d-flex justify-content-center">
          <div class="spinner-border text-warning" role="status">
            <span class="visually-hidden">A carregar...</span>
          </div>
  ...
  <section class="cta-section">
    <div class="container">
      <div class="cta-content">
        <h2 class="cta-title">Pronto para Competir?</h2>
        <p class="cta-description">Junta-te a milhares de jogadores em todo o mundo e prova o teu valor nas pistas.
          Novos modos são adicionados regularmente para manter o desafio sempre fresco e empolgante.</p>
        <div class="cta-buttons">
          <a href="https://www.roblox.com/pt/games/113586179382037/KR-Legends-Beta" target="_blank" class="cta-button"
            id="jogar_agora_final">
            <i class="bi bi-controller"></i> Jogar Agora
          </a>
          <a href="Comunidade.php" class="cta-button cta-outline">
            <i class="bi bi-people"></i> Juntar-se à Comunidade
          </a>
        </div>
      </div>
    </div>
  ...
  <script src="js/modos-de-jogo.js"></script>
