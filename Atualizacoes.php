...
<head>
  ...
  <title>KR Legends - Atualizações</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
  <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css" rel="stylesheet">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
  <link href="css/Atualizacoes.css" rel="stylesheet">
...
<body class="bg-black text-white">
  ...
  <section id="hero" class="min-vh-100 d-flex align-items-center text-center position-relative overflow-hidden">
    ...
    <div class="container position-relative hero-content">
      <h1 class="display-2 fw-bold text-warning mb-4 fade-in" data-translate="hero.pitstop">Pit Stop de Novidades</h1>
      <p class="lead text-white mb-5 mx-auto slide-up" style="max-width: 600px;" data-translate="hero.subtitle">
        Acompanha o desenvolvimento de <b>KR Legends</b> com atualizações contínuas sobre melhorias, novos recursos e o
        que está por vir. Fica por dentro de tudo o que está a acontecer na pista.
      </p>
    ...
    <header class="container-fluid">
      <div class="row py-4">
        <div class="col-12 text-center">
          <h1 class="update-title"><span class="text-yellow">KR</span> LEGENDS</h1>
          <p class="update-subtitle">CORRIDA RUMO À GLÓRIA • ÚLTIMAS ATUALIZAÇÕES</p>
        </div>
      </div>
    </header>
  </div>
  ...
  <main class="container timeline-container">
    ...
    <div class="mt-5">
      <button id="load-more-btn" class="btn btn-yellow">
        Ver mais
      </button>
    </div>
  </main>
  ...
  <script src="JSON/Infos/Info_Atualizacoes.json" type="module"></script>
  ...
  <script src="js/Traducoes/translations_atualizacoes.js"></script>
